...
/**
 * Leaderboard específico de UIGuessr. Análogo a
 * commitguessr/commit-leaderboard, pero consulta /ui-leaderboard (shard
 * "uiguessr"): el techo de puntaje de UIGuessr (1800 pts/ronda) es mucho
 * más alto que el de CodeGuessr (300 pts/ronda), por lo que mezclarlos en
 * un solo ranking haría que UIGuessr domine siempre la tabla.
 */
@Component({
  selector: 'app-ui-leaderboard',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './ui-leaderboard.html',
  styleUrl: './ui-leaderboard.scss',
})
export class UILeaderboard implements OnInit {
